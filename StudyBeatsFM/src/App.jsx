...
function App() {
  ...
  const LofiGirlVideo = () => {
    setVideo("https://www.youtube.com/watch?v=6m71lhTlIJM&t=1931s&ab_channel=1992");
  ...
  const animeVibe = () => {
    setVideo("//www.youtube.com/watch?v=syvz6eOcSv0&ab_channel=MODY");
    setStationName("FinD");
    setYoutubeChannal("https://www.youtube.com/c/SINGOFFICIAL");
    setLivestream(
      "https://www.youtube.com/watch?v=CMNEgK9rUoM&ab_channel=Fin%27D"
    );
    playLiveStream(true);
    setPauseScreen("unpauseScreen");
    setPlayPause(pauseImg);
  ...
  return (
    <div className="interfaceContainer">
      <div className="radioContainer">
        <div className="logo">YeuEmChi</div>
